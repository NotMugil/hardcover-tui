...
- [ ] ~~Setup discovery / popular books in search~~ (not now)
- [x] Show user's activity in Profile/Library
    - [x] Make it easy to read and comprehend
- [ ] Add option to rearrange/order the books in the list (Ordered Lists)
